...
// ALEX begin
	...
	{
//	        fprintf(stdout,"computing kernel %d %d\n",i,j);
 ...
 gamma(param.gamma), coef0(param.coef0)
{
	switch(kernel_type)
	{
		...
		case SIGMOID:
			...
			break;
		case SUMMIN:
			kernel_function = &Kernel::kernel_sum_min;
			break;
		case PRECOMPUTED:
...
//BEGIN MAJI predict probabilities when values are given
double svm_predict_probability2(
				const svm_model *model, const svm_node *x, double *prob_estimates, double* dec_values)
{
...
{
// ALEX begin
	"linear","polynomial","rbf","sigmoid","summin","precomputed",NULL
// ALEX end
};
