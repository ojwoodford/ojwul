...
function varargout = vl_mser(varargin)
base = '../private/vlfeat';
sourceList = {['-I' base], 'vl_mser.c', [base '/vl/mser.c'], [base '/vl/generic.c'], [base '/vl/host.c'], [base '/vl/random.c']}; % Cell array of source files
